...
def test_exact_tag_matches():
    core.exist_wis = [{TITLE: {4821: {"tags": "ProductX/api; security vulnerability", "state": "Active"}}}]
...
def test_prefix_overlapping_project_does_not_match():
    ...
    core.exist_wis = [{TITLE: {4821: {"tags": "ProductX/api-client; security vulnerability", "state": "Active"}}}]
...
def test_picks_one_id_when_duplicates_exist():
    ...
    core.exist_wis = [
        {TITLE: {4821: {"tags": "ProductX/api; security vulnerability", "state": "Active"}}},
        {TITLE: {4999: {"tags": "ProductX/api; security vulnerability", "state": "Active"}}},
    ]
...
def test_multi_key_entry_values_are_not_welded_together():
    ...
    losing a real one."""
    core.exist_wis = [{TITLE: {4821: {"tags": "ProductX/ap", "state": "Active"}, 4822: {"tags": "i; security vulnerability", "state": "Active"}}}]
...
def test_two_repos_sharing_a_library_each_keep_their_own_item():
    ...
    core.exist_wis = [
        {TITLE: {4821: {"tags": "ProductX/api; security vulnerability", "state": "Active"}}},
        {TITLE: {4822: {"tags": "ProductX/api-client; security vulnerability", "state": "Active"}}},
    ]
    assert core.check_wi_id(id=TITLE, project_name="ProductX/api") == 4821
...
def test_matching_finds_by_predicate():
    core.exist_wis = [{LEGACY: {4821: {"tags": "ProductX/api; security vulnerability", "state": "Active"}}}]
...
def test_matching_still_requires_the_project_tag():
    ...
    core.exist_wis = [{LEGACY: {4821: {"tags": "ProductX/api-client; security vulnerability", "state": "Active"}}}]
    assert core.check_wi_id_matching(
...
def test_matching_ignores_a_malformed_entry_and_still_finds_a_good_one():
    core.exist_wis = [
        {LEGACY: 12345},
        {LEGACY: {4821: {"tags": "ProductX/api; security vulnerability", "state": "Active"}}},
    ]
    assert core.check_wi_id_matching(
        lambda t: t.startswith("log4j-core:"), project_name="ProductX/api") == 4821
...
def test_a_raising_predicate_does_not_abort_the_search():
    ...
    core.exist_wis = [
        {"bad": {1: {"tags": "ProductX/api", "state": "Active"}}},
        {LEGACY: {4821: {"tags": "ProductX/api; security vulnerability", "state": "Active"}}},
    ]
