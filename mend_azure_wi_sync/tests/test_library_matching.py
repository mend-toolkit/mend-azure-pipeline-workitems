...
def test_finds_the_work_item_whatever_the_count_says():
    core.exist_wis = [
        {"log4j-core: 3 vulnerabilities (highest severity is 9.8)": {4821: {"tags": TAGS, "state": "Active"}}}]
...
def test_suppressing_a_vulnerability_still_finds_the_same_item():
    ...
    core.exist_wis = [
        {"log4j-core: 2 vulnerabilities (highest severity is 7.5)": {4821: {"tags": TAGS, "state": "Active"}}}]
    assert _find("log4j-core", "ProductX/api") == 4821
...
def test_still_requires_the_project_tag():
    core.exist_wis = [
        {"log4j-core: 3 vulnerabilities (highest severity is 9.8)":
            {4821: {"tags": "ProductX/api-client; security vulnerability", "state": "Active"}}}]
...
def test_does_not_claim_a_license_work_item():
    core.exist_wis = [
        {"License Policy Violation detected in log4j-core": {4821: {"tags": TAGS, "state": "Active"}}}]
    assert _find("log4j-core", "ProductX/api") == 0
