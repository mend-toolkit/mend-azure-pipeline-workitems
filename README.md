...
| `MEND_CALCULATESEVERITY` | boolean |   No*    | False | Severity will be calculated based on CVSS 3 score and mapped to Azure Work Item severity levels if set to True. Mapping: Critical (9.0-10.0) = "1 - Critical", High (7.0-8.9) = "2 - High", Medium (4.0-6.9) = "3 - Medium", Low (0.1-3.9) = "4 - Low". If False, the field will not be populated.                                                                                                                                                                                                                                                                                                                                                                                                                                |
