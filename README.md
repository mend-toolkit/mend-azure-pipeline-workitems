...
| `MEND_DESCRIPTION`  | string  |   No*    | <Dependency Information\> <br /> **_Do not change_** | Used for storing base information about violations and vulnerabilities in specific custom field. <br/> See [Custom Work Item Types](#custom-field-mapping) below for syntax guidelines. |
